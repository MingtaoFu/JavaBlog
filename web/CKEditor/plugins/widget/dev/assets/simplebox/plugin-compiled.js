...
CKEDITOR.plugins.add('simplebox', {
	...
	init: function (editor) {
		...
		editor.widgets.add('simplebox', {
			...
			allowedContent: 'div(!simplebox,align-left,align-right,align-center){width};' + 'div(!simplebox-content); h2(!simplebox-title)',
			...
			template: '<div class="simplebox">' + '<h2 class="simplebox-title">Title</h2>' + '<div class="simplebox-content"><p>Content...</p></div>' + '</div>',
			...
			data: function () {
				...
				if (!this.data.width) this.element.removeStyle('width');else this.element.setStyle('width', this.data.width);
